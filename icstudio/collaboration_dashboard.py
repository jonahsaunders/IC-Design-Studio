...
class CollaborationDashboard(QDialog):
    def __init__(self, studio):
        ...
        root.setSpacing(12)
        heading = note('Work on a layout together')
        ...
        overview.addWidget(note('Sharing starts a live layout workspace on your team’s server. To join, paste the invitation your teammate sent you.'))
        ...
        footer.addStretch()
        button('Back to layout', self.hide, footer)

...
GROUPS = {
 ...
 'Layout/Generate': ['Common-centroid placement…','Generate generic MOS geometry…','Generate metal guard ring…','Generate PDK device layout…','Generate inverter layout…','Generate contacted SKY130 guard…','Add tied SKY130 MOS dummy…','Generate current mirror layout…','Generate analog reference layout…'],

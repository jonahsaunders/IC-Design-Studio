...
GROUPS = {
 ...
 'File/Examples': ['New PDK inverter…','New PDK ring oscillator…','New PDK current mirror','New PDK differential pair','New PDK amplifier','New SKY130 two-stage op-amp'],
 ...
 'Layout/Generate': ['Common-centroid placement…','Generate generic MOS geometry…','Generate metal guard ring…','Generate PDK device layout…','Generate inverter layout…','Generate contacted SKY130 guard…','Add tied SKY130 MOS dummy…','Generate current mirror layout…','Generate analog reference layout…','Generate two-stage op-amp layout…'],
 'Route': ['Place via','Place via…','Autovia…','Route linked terminals…','Route between coordinates…','Assign physical terminal…','Assign cell layout port…','Stretch path segment…','Stretch path with mouse','Cut wire','Rejoin two wires','Toggle junction at pointer'],

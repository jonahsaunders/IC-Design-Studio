...
GROUPS = {
 ...
 'File/Examples': ['New custom SKY130 inverter','New SKY130 ring oscillator','New PDK current mirror','New PDK differential pair','New GF180 3.3 V inverter'],
 ...
 'Layout/Generate': ['Common-centroid placement…','Generate generic MOS geometry…','Generate metal guard ring…','Generate PDK device layout…','Generate inverter layout…','Generate current mirror layout…'],
 ...
 'Verify/Physical verification': ['Verify custom inverter through silicon','Verify saved testbench layout','Compare netlists with Netgen…','Run SKY130 inverter reference…','Extract layout through Magic…','Estimate ground capacitance'],

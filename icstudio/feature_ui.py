...
class FeatureMixin:
    ...
    def make_actions(self):
        ...
        'Tools':[('Run SKY130 inverter reference…',self.sky130_reference_dialog),('Installed PDK revisions…',self.pdk_manager),('Extract layout through Magic…',self.magic_extract_dialog)]}
        self._feature_menus=[]

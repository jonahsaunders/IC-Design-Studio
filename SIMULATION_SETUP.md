...
## Included GF180 bandgap schematic

`examples/gf180-bandgap/5vfullv2-original.sch` is byte-for-byte identical to the contributed `5vfullv2(20260910-015224).sch`. Open it directly or select **08 · GF180 full characterization** in the gallery. F5 runs its 144 analyses. Allow several minutes or longer, depending on the machine.

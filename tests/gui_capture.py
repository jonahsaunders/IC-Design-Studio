...
w.set_capture_profile('Classic analog');w.select([d['id']]);key(Qt.Key_C);click(100,150);key(Qt.Key_Escape);assert len(w.cell['devices'])==2 and w.schematic.capture_preview is None

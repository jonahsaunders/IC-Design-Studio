...
def main():
    docs = ['docs/SCHEMATIC_COLLABORATION.md', 'docs/PROFESSIONAL_WORKFLOWS.md', 'README.md', 'CONTRIBUTING.md', 'examples/README.md', 'docs/GETTING_STARTED.md', 'docs/LAYOUT_3D.md', 'docs/LIVE_COLLABORATION.md',

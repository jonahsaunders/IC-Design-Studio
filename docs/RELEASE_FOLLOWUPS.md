...
The current candidate is **0.22.0.dev24**. Automated qualification and manual
...
1. Run desktop/package, external interoperability, pinned physical, digital and
   VGA workflows on the selected source commit. Inspect failures and retained

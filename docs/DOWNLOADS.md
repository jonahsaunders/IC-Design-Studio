...
| `SHA256SUMS-0.22.0.dev13.txt` | Final download checksums |
...
On Linux, run `sha256sum -c SHA256SUMS-0.22.0.dev13.txt` in the download directory.
On Windows, run `Get-FileHash .\IC-Design-Studio-0.22.0.dev13-Windows-x64-Setup.exe -Algorithm SHA256`

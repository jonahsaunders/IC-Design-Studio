...
| Xschem exchange | Existing declarative symbols and mirror-aware schematic package exchange; required-pin metadata retained | Package locks remain enforced; arbitrary scripts/proprietary database are unsupported |

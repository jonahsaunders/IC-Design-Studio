...
| **Layout editing** | GDSII/OASIS hierarchy, rectangles, polygons, holes and paths; configurable grids, snapping, alignment, distribution, arrays, manual vias, Autovia in selected overlaps and routing tools | [Layout tools](docs/PRIORITIES_0.22.md) · [Drawing](docs/DRAWING_0.22.md) · [Vias](docs/LAYOUT_VIAS.md) |
